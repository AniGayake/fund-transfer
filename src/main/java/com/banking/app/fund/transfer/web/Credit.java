...
public class Credit {
    ...
    @PostMapping("/credit")
    public ResponseEntity<FundCreditResponse> creditAccount(final @RequestBody CreditRequest creditRequest){
        ...
        FundCreditResponse fundCreditResponse = transactionService.populateFundCreditResponse(transaction);
        if(null==fundCreditResponse){
        ...
        System.out.println(accountRepository.findById(creditRequest.getAccountNumber()).get());
